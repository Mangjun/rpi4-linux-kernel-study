...
본 리포지토리는 도서 <b>[리눅스 커널의 구조와 원리 1, 2권]</b>을 기반으로, 현업에서 요구하는 핵심 커널 디버깅 및 디바이스 드라이버 개발 역량을 단기간에 마스터하기 위한 실습 및 트러블슈팅 기록입니다.

단순한 이론 공부를 넘어, 호스트 PC에서 크로스 컴파일을 수행하고 타겟 보드(**Raspberry Pi 4**)에 동적으로 모듈을 적재하며 발생하는 다양한 이슈들을 해결하는 과정을 담고 있습니다.
